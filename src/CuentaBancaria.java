public class CuentaBancaria {
    ...
    public synchronized void retirar(double monto) throws SaldoInsuficiente {
        if (monto > saldo) {
            throw new SaldoInsuficiente("Saldo insuficiente. Saldo actual: " + saldo + ", Monto a retirar: " + monto);
        }
        saldo -= monto;
